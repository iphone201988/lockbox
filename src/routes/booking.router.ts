...
import { bookingStatusUpdate, checkBooking, checkInBooking, disputeStorage, getAllBookingOfHost, getAllBookingOfRenter, getInsurancePlan, requestBooking } from "../controllers/booking.controller";
...
bookingRouter.post('/check_in', authMiddleware, upload.array("images"), validate(check_inSchema), checkInBooking);
